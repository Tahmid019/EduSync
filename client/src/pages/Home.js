...
function Home() {
    ...
    return (
        <div>
            <header className="header bg-blue" style={{ backgroundImage: "url('https://soundproofexpert.com/wp-content/uploads/2021/04/How-Do-Sound-Waves-Travel.jpg')", "backgroundSize": "cover", "backgroundPosition":"right" , "width":"-webkit-fill-available"}}>
