...
TRANSCRIPTIONS_FOLDER = 'transcription/'
...
def upload_file():
    ...
    try:
        ...
        for start, end in non_silent_regions:
            ...
            translated_audio_path = text_to_speech_from_text(translated_text, lang=dest_lang, pitch_change=-10)
...
#     connection.close()
#     if user:
#         return jsonify({'message': 'Logi000n successful'}), 200
#     else:
#         return jsonify({'message': 'Invali0000d email or password'}), 401
