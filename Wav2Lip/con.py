...
def convert_mp4_to_wav(mp4_file_path):
    try:
        ...
        wav_file_path = '/home/oem/LIPSYNC/reactdb new try/reactdb1 (1)/reactdb/client/Wav2Lip/te.wav'
...
convert_mp4_to_wav('/home/oem/LIPSYNC/reactdb new try/reactdb1 (1)/reactdb/client/Wav2Lip/te.mp4')