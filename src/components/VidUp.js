...
import axios from 'axios';
import "../css/VideoUpload.css";
// import result from '../../Wav2Lip/results/result_voice.mp4'
...
function VidUp() {
  ...
  const handleUpload = async (e) => {
    ...
    formData.append('sr_lang', srLang); // Add destination language to formData
    ...
    try {
      ...
      console.error('Error uploading file', error);
      try{
        const response = await fetch('/processed/merged_final_video_${utc_str}')
        const videoUrl = response.data.video_url
  ...
  //   formData.append('video', file);
  //   formData.append('dest_lang', destLang);
  //   formData.append('sr_lang', srLang); // Add source language to formData
  //   formData.append('u_mail_id', usrmailid);
  //   formData.append('utc_str', utc_str);
  ...
  //     const message = response.data.message;
  //     const videoUrl = response.data.video_url;
  //     const transcription = response.data.transcription_url || 'Transcription unavailable';
  //     console.log(videoUrl)
